...
public class UsuarioView {
    ...
    public void imprimirComandos() {
        ...
        System.out.println("--versionar [comentário] : cria uma nova versao\n");
        // System.out.println("--adicionar [parâmetro]: adiciona item(s) ao container
        // \n\tparâmetro: \n\t '.' adiciona TODO conteúdo do container \n\t 'nome do
        // arquivo' adiciona o arquivo específico do container\n");
        ...
        // arquivo' remove o arquivo específico do container\n");
        // System.out.println("--excluir [id] : excluí uma determinada versão de acordo
        // com seu id\n");
    }
}
