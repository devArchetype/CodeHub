...
public class RepositorioController {
  ...
  public void adicionaAoContainer(String arquivoAdicionar) {
    ...
    File arquivoContainerJson = new File(this.repositorio.getPath() + Arquivo.resolvePath() + "container" + Arquivo.resolvePath() + "container.json");
    try {
    ...
    try {
      ...
      if (diretorioPai.listFiles() != null) {
        ...
        for (File arquivoVerificar : diretorioPai.listFiles()) {
          if (arquivoAdicionar.equals(".") && !arquivoVerificar.getName().equals(".CodeHub") && !arquivoVerificar.getName().equals("CodeHub.jar")) {
